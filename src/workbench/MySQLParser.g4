...
// $antlr-the_format alignTrailingComments on, columnLimit 130, minEmptyLines 1, maxEmptyLinesToKeep 1, reflowComments off
// $antlr-the_format useTab off, allowShortRulesOnASingleLine off, allowShortBlocksOnASingleLine on, alignSemicolons ownLine
...
showStatement:
    SHOW_SYMBOL (
        ...
        | value = CREATE_SYMBOL (
            ...
            | {serverVersion >= 50704}? the_object = USER_SYMBOL user
        )
...
otherAdministrativeStatement:
    ...
    | {serverVersion >= 50709}? the_type = SHUTDOWN_SYMBOL
;
...
dataType: // the_type in sql_yacc.yy
    ...
    | (the_type = CHAR_SYMBOL VARYING_SYMBOL | the_type = VARCHAR_SYMBOL) fieldLength charsetWithOptBinary?
    | (
    ...
    | {serverVersion >= 50708}? the_type = JSON_SYMBOL
    | the_type = (
        GEOMETRY_SYMBOL
